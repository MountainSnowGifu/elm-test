...
{
	if (region.O.E === region.aa.E)
	{
		return 'on line ' + region.O.E;
	}
	return 'on lines ' + region.O.E + ' through ' + region.aa.E;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {af: fragment, aj: host, ar: path, at: port_, ax: protocol, ay: query};
	});
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			bc: function (_v0) {
				return _Utils_Tuple2(impl.bc, $elm$core$Platform$Cmd$none);
			},
			bv: function (_v1) {
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{bc: $author$project$Main$init, bz: $author$project$Main$update, bA: $author$project$Main$view});
